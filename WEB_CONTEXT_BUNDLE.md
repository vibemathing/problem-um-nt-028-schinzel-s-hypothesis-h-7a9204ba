...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-nt-028-schinzel-s-hypothesis-h-7a9204ba-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/NT-028"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-nt-028-schinzel-s-hypothesis-h-7a9204ba-v1",
      "problem_contract_sha256": "cbc034e3eb110ee1b005c2102ad23b03bc8df8f12c7bccacf56a34d3d2ac5aae",
      "problem_id": "problem:um-nt-028-schinzel-s-hypothesis-h-7a9204ba",
      "route_id": "route:um-nt-028-schinzel-s-hypothesis-h-7a9204ba-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-nt-028-schinzel-s-hypothesis-h-7a9204ba-source-fidelity-01",
      "graph_id": "graph:um-nt-028-schinzel-s-hypothesis-h-7a9204ba-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-nt-028-schinzel-s-hypothesis-h-7a9204ba-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-nt-028-schinzel-s-hypothesis-h-7a9204ba-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "If polynomials satisfy certain necessary divisibility conditions, do they simultaneously produce infinitely many primes for integer inputs?"
          },
          "statement_sha256": "e41885b8711be4de413caad51c2b9c9c7bd2d9ccd2ca821876e5cbabb23554f3"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-nt-028-schinzel-s-hypothesis-h-7a9204ba-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-nt-028-schinzel-s-hypothesis-h-7a9204ba-root",
      "route_id": "route:um-nt-028-schinzel-s-hypothesis-h-7a9204ba-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-nt-028-898669af718e",
        "url": "https://www.unsolvedmath.com/problems/NT-028"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
